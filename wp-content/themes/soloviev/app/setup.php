...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('fonts/google', 'https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,400;0,600;0,700;1,400&display=swap', [], null);
    wp_enqueue_style('fonts/adobe', 'https://use.typekit.net/zqh2euk.css', [], null);
